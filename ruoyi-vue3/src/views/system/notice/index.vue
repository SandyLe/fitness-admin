<template>
   <div class="app-container">
      ...
      <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
         ...
         <el-table-column label="Index" align="center" prop="noticeId" width="100" />
         <el-table-column
      ...
      <el-dialog :title="title" v-model="open" width="780px" append-to-body>
         <el-form ref="noticeRef" :model="form" :rules="rules" label-width="80px">
            <el-row>
               ...
               <el-col :span="12">
                  <el-form-item :label="$t('notice.noticeType')" prop="noticeType">
                     <el-select v-model="form.noticeType" :placeholder="$t('notice.noticeTypePlaceholder')">
                        <el-option
                           v-for="dict in sys_notice_type"
                           :key="dict.value"
                           :label="dict.label"
...
const data = reactive({
  ...
  rules: {
    noticeTitle: [{ required: true, message: proxy.$t('notice.noticeTitleRequired'), trigger: "blur" }],
    noticeType: [{ required: true, message: proxy.$t('notice.noticeTypePlaceholder'), trigger: "change" }]
  },
})
...
function handleAdd() {
  reset()
  open.value = true
  title.value = proxy.$t('notice.addNotice')
}
...
function handleUpdate(row) {
  ...
  getNotice(noticeId).then(response => {
    ...
    open.value = true
    title.value = proxy.$t('notice.updateNotice')
  })
}
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm(proxy.$t('notice.confirmDeleteNotice') + noticeIds + proxy.$t('common.menuName')).then(function() {
