<template>
   <div class="app-container">
      <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch">
         <el-form-item :label="$t('post.postNo')" prop="postCode">
            <el-input
               v-model="queryParams.postCode"
               :placeholder="$t('post.postNoPlaceholder')"
               clearable
               style="width: 200px"
         ...
         <el-form-item>
            ...
            <el-button type="info" icon="Refresh" @click="resetQuery">
               {{ $t('common.reset') }}
            </el-button>
         </el-form-item>
      </el-form>
      ...
      <el-dialog :title="title" v-model="open" width="500px" append-to-body>
         <el-form ref="postRef" :model="form" :rules="rules" label-width="80px">
            ...
            <el-form-item :label="$t('post.postCode')" prop="postCode">
               <el-input v-model="form.postCode" :placeholder="$t('post.postCodePlaceholder')" />
            </el-form-item>
            <el-form-item :label="$t('post.postSort')" prop="postSort">
               <el-input-number v-model="form.postSort" controls-position="right" :min="0" :placeholder="$t('post.postSortPlaceholder')" />
            </el-form-item>
            <el-form-item :label="$t('post.status')" prop="status">
            ...
            <el-form-item :label="$t('common.remark')" prop="remark">
               <el-input v-model="form.remark" type="textarea" :placeholder="$t('common.remarkPlaceholder')" />
            </el-form-item>
         </el-form>
         <template #footer>
...
const data = reactive({
  ...
  rules: {
    postName: [{ required: true, message: proxy.$t("post.postNameRequired"), trigger: "blur" }],
    postCode: [{ required: true, message: proxy.$t("post.postCodeRequired"), trigger: "blur" }],
    postSort: [{ required: true, message: proxy.$t("post.postSortRequired"), trigger: "blur" }],
  }
})
...
function handleAdd() {
  reset()
  open.value = true
  title.value = proxy.$t("post.addPost")
}
...
function handleUpdate(row) {
  ...
  getPost(postId).then(response => {
    ...
    open.value = true
    title.value = proxy.$t("post.updatePost")
  })
}
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm(proxy.$t("post.confirmDeletePost") + '"' + postIds + proxy.$t("common.menuName") + '"?').then(function() {
