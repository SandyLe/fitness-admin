<template>
  <div class="app-container">
    <el-row :gutter="10">
        ...
        <el-card>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody>
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('server.cpuNum')}}</div></td>
                ...
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('server.sysUsage')}}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" v-if="server.cpu">{{ server.cpu.sys }}%</div></td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('server.freeUsage')}}</div></td>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              ...
              <tbody>
                ...
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('server.usage')}}</div></td>
            ...
            <table cellspacing="0" style="width: 100%;">
              <tbody>
                <tr>
                  ...
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('server.osName')}}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" v-if="server.sys">{{ server.sys.osName }}</div></td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('server.serverIp')}}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" v-if="server.sys">{{ server.sys.computerIp }}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('server.osArch')}}</div></td>
      ...
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header><CoffeeCup style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">{{$t('server.javaVmInfo')}}</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;table-layout:fixed;">
              <tbody>
                ...
                <tr>
                  <td colspan="1" class="el-table__cell is-leaf"><div class="cell">{{$t('server.installPath')}}</div></td>
        ...
        <el-card>
          ...
          <div class="el-table el-table--enable-row-hover el-table--medium">
            <table cellspacing="0" style="width: 100%;">
              <thead>
                <tr>
                  <th class="el-table__cell el-table__cell is-leaf"><div class="cell">{{$t('server.dirName')}}</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">{{$t('server.sysTypeName')}}</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">{{$t('server.typeName')}}</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">{{$t('server.total')}}</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">{{$t('server.free')}}</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">{{$t('server.used')}}</div></th>
                  <th class="el-table__cell is-leaf"><div class="cell">{{$t('server.usa')}}</div></th>
                </tr>
              </thead>
...
function getList() {
  proxy.$modal.loading(proxy.$t('server.loading'))
