  ...
  <div class="app-container">
    <el-row :gutter="10">
      <el-col :span="24" class="card-box">
        <el-card>
          <template #header><Monitor style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">{{$t('cache.cacheName')}}</span></template>
            ...
            <table cellspacing="0" style="width: 100%">
              <tbody>
                <tr>
                  ...
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('cache.clientNum')}}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" v-if="cache.info">{{ cache.info.connected_clients }}</div></td>
                </tr>
                <tr>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('cache.runTime')}}</div></td>
                  ...
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('cache.maxMemory')}}</div></td>
                ...
                <tr>
                  ...
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('cache.keyNum')}}</div></td>
                  <td class="el-table__cell is-leaf"><div class="cell" v-if="cache.dbSize">{{ cache.dbSize }} </div></td>
                  <td class="el-table__cell is-leaf"><div class="cell">{{$t('cache.netIo')}}</div></td>
      ...
      <el-col :span="12" class="card-box">
        <el-card>
          <template #header><Odometer style="width: 1em; height: 1em; vertical-align: middle;" /> <span style="vertical-align: middle;">{{$t('cache.usedMemory')}}</span></template>
          <div class="el-table el-table--enable-row-hover el-table--medium">
...
function getList() {
  proxy.$modal.loading(proxy.$t('cache.loadingCacheInfo'))
          ...
          data: [
            {
              ...
              name: proxy.$t('cache.usedMemoryed')
            }
          ]
        }
      ]
